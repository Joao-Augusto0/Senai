...
public class Ex12 {
	...
	public static void main(String[] args) {
		...
		salario = leia.nextFloat();
			 ...
			 if( salario < 1903.98) {
                 System.out.print("Não sera descontado nada do seu salario!");
                 
             }else if(salario > 1903.98 && salario < 2826.65) {
            	 
                 desconto =  (float) ((salario*7.5)/100);
                 salario = salario - desconto;
                 System.out.print("O desconto no seu salario é de: " +desconto);
                 System.out.print("Seu salário com desconto fica: "+ salario);
